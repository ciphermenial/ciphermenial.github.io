---
layout: post
title:  Install Xibo on Ubuntu 21.04
categories: [Server,Linux,Install]
excerpt: This guide shows how to install Xibo CMS 3.0.2 onto Ubuntu 21.04
---

# Introduction
I have installed Xibo CMS on Ubuntu Server 21.04 using Apache2 as the web server and enforcing TLS using this configuration. I have completed this using the autogenerated self-signed certificates for TLS (not trusted). You will need to follow another guide for creating public-signed certificates. I recommend using Let's Encrypt with their certbot.
