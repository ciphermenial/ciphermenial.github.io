...
I have installed [Xibo CMS](https://xibo.org.uk/cms) on Ubuntu Server 21.04 using Apache2 as the web server and enforcing TLS using this configuration. I have completed this using the autogenerated self-signed certificates for TLS (not trusted). You will need to follow another guide for creating public-signed certificates. I recommend using [Let's Encrypt](https://letsencrypt.org) with their certbot.
