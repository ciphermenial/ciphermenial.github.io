...
> The previous guide no longer worked due to changes to XMR. It now treats the old tcp connections as legacy and prioritises websockets.
{: .prompt-info }
...
This guide is updated for installing [Xibo CMS 4.4.4](https://xibosignage.com/blog/june-2026-releases).
